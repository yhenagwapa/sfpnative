            ...
            <div class="card">
              <div class="card-body">
                <div class="col mt-4 mb-6">
                  <a href="add-user-account.php"><button type="button" class="btn btn-primary"><i class="bi bi-plus-circle"></i> New Account</button></a>
                </div>
                ...
                <table class="table datatable mt-3">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>Day Care Worker</td>
                      <td><a href="update-user-account.php"><button type="button" class="btn btn-primary"><i class="bi bi-eye"></i> View</button></a> </td>
                    </tr>
                    <tr>
